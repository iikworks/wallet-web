...
export default function AccountBlock(props: AccountBlockProps) {
  return (
    <div className="bg-sapling-light-shade rounded-xl h-28 hover:scale-105 transition py-3 px-5">
      <div className="flex flex-col justify-between">
        <div className="flex justify-between items-center">
          <div className="text-sapling-dark-shade-2 font-medium">
          ...
          <div className="flex leading-5 justify-between items-center">
            <div className="text-xl font-medium text-flame-sea">
              {currencyFormat(props.account.currency, props.account.balance)}
            </div>
          </div>
        </div>
        <div className="text-sm text-sapling-dark-shade-2 mt-5">
