  ...
  return (
    <form onSubmit={handleSubmit} method="POST" className="mt-5 space-y-4">
      ...
      <Select error={props.errors.type}
              ...
              title="Тип счета" />
      {form.type === CONSTANTS.ACCOUNT_BANK_ACCOUNT_TYPE &&<div className="pt-3 border-y-2 space-y-4">
          <TextInput type="text"
                     name="account_number"
                     title="Номер счета"
      ...
      {form.type === CONSTANTS.ACCOUNT_CARD_TYPE &&<div className="py-3 border-y-2 space-y-4">
