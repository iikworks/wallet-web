  ...
  return (
    <div>
      ...
      <IMaskInput
        ...
        name={props.name}
        id={props.name}
        className="mt-1 py-1.5 px-2.5 block rounded-lg text-sm border-none text-sapling-dark-shade-2 placeholder-sapling-dark-shade-1 font-medium bg-sapling w-full"
        ref={ref}
        inputRef={inputRef}
